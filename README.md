...
## Preview
<img src="/art/waving.gif" width="1280" alt="the waving Effect">
...
Download the latest version from the **[Releases](https://github.com/affsvoyo/Strident-Crisis-Shader-Generator/releases)** page.

## 🛠️ How to Use

1. Download and extract the `.zip` file
2. Run `Generator.exe`
3. Adjust the parameters using the sliders and controls
4. See the effect update in real-time
5. Export the shader when you're happy with the result
...
git clone https://github.com/affsvoyo/Strident-Crisis-Shader-Generator.git
cd Strident-Crisis-Shader-Generator
